 ...
 **  @date 24/06/2011
 **  @author RussW
 **  @translation to Finnish Tero Kankaanperä tero@terokankaanpera.fi
 **/
    ...
    define ( '_RES_LANG', 'fi-FI' );               // Country/Language Code
    ...
    // slow screen message
    // v1.2.0
    define ( '_FPA_SLOWGENPOST', 'Luodaan raporttikoodia...' );
    define ( '_FPA_SLOWRUNTEST', 'Odota hetki, suoritamme kokeita...' );
    ...
    // v1.2.0
    define ( '_FPA_INSTRUCTIONS', 'Ohjeet' );
    define ( '_FPA_INS_1', 'Kirjoita kuvaus ongelmastasi <i>(valinnainen)</i>' );
    define ( '_FPA_INS_2', 'Kopioi tai kirjoita tähän virheilmoitus/-kset <i>(valinnainen)</i>' );
    define ( '_FPA_INS_3', 'Miten olen yrittänyt ratkaista ongelmaa? <i>(valinnainen)</i>' );
    define ( '_FPA_INS_4', 'Valitse tuotettavan raportin yksityskohtien taso <i>(valinnainen)</i>' );
    define ( '_FPA_INS_5', 'Paina <span class="normal-note">Luo raportti</span> -nappia luodaksesi foorumille liitettävän koodin' );
    define ( '_FPA_INS_6', 'Kopioi <span class="ok-hilite">&nbsp;Raporttikoodi&nbsp;</span> ruudun sisältö kokonaisuudessaan ja liitä se foorumiviestiisi' );
    define ( '_FPA_POST_NOTE', 'Voit jättää kaikki kentät tyhjiksi kerätäksesi vain diagnostiset tiedot.' );
    define ( '_FPA_PROB_DSC', 'Ongelman kuvaus' );
    define ( '_FPA_PROB_MSG', 'Loki/virheilmoitus' );
    define ( '_FPA_PROB_ACT', 'Ongelman korjaamiseksi tehdyt toimet' );
    define ( '_FPA_PROB_CRE', 'Toimet ongelman toisintamiseksi' );
    define ( '_FPA_OPT', 'Valinnaiset asetukset' );
    define ( '_FPA_SHOWELV', 'Näytä korotetut kansioiden oikeudet' );
    define ( '_FPA_SHOWDBT', 'Näytä tietokantataulujen tilastot' );
    define ( '_FPA_SHOWCOM', 'Listaa komponentit' );
    define ( '_FPA_SHOWMOD', 'Listaa modullit' );
    define ( '_FPA_SHOWPLG', 'Listaa liitännäiset' );
    define ( '_FPA_INFOPRI', 'Tietosuoja' );
    define ( '_FPA_PRIVNON', 'Ei mitään' );
    define ( '_FPA_PRIVNONNOTE', 'Mitään ei peitetä' );
    define ( '_FPA_PRIVPAR', 'Osittainen' );
    define ( '_FPA_PRIVPARNOTE', 'Jotkin tiedot peitetään' );
    define ( '_FPA_PRIVSTR', 'Tiukka' );
    define ( '_FPA_PRIVSTRNOTE', 'Kaikki tunnistettavat tiedot peitetään' );
    define ( '_FPA_CLICK', 'Luo raportti' );
    define ( '_FPA_OUTMEM', 'Muistiloppu/Out of Memory');
    define ( '_FPA_OUTTIM', 'Suorituksen aikakatkaisu/Execution Time-Outs' );
    define ( '_FPA_INCPOPS', 'Lisää väliaikaisesti PHP muistia ja suoritusaikaa' );
    define ( '_FPA_POSTD', 'Raporttikoodi' );
